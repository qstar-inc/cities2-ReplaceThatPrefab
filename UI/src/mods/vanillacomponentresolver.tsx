...
const registryIndex = {
  ...
  toggleTheme: [
    "game-ui/menu/widgets/toggle-field/toggle-field.module.scss",
    "classes",
  ],
  ...
  Bounds1InputField: [
    "game-ui/editor/widgets/fields/bounds-field.tsx",
    "Bounds1InputField",
  ], // rB
  HexColorInput: [
    "game-ui/common/input/text/hex-color-input.tsx",
    "HexColorInput",
  ], //extends jG
  RadialHuePicker: [
    "game-ui/common/input/color-picker/radial-hue-picker/radial-hue-picker.tsx",
    "RadialHuePicker",
  ],
  ColorPickerPreview: [
  ...
  BoundIntInputField: [
    "game-ui/game/widgets/field/int-input-field.tsx",
    "BoundIntInputField",
  ],
  textInputTheme: [
  ...
  ellipsesTextInputTheme: [
    "game-ui/common/input/text/ellipsis-text-input/ellipsis-text-input.module.scss",
    "classes",
  ],
  EllipsisTextInput: [
    "game-ui/common/input/text/ellipsis-text-input/ellipsis-text-input.tsx",
    "EllipsisTextInput",
  ],
  assetGridTheme: [
...
export class VanillaComponentResolver {
  ...
  public get HexColorInput(): (props: HexColorInput) => JSX.Element {
    return (
      this.cachedData["HexColorInput"] ?? this.updateCache("HexColorInput")
    );
  }
  public get Bounds1InputField(): (props: Bounds1InputField) => JSX.Element {
    return (
      this.cachedData["Bounds1InputField"] ??
      this.updateCache("Bounds1InputField")
    );
  }
  public get RadialHuePicker(): (props: RadialHuePicker) => JSX.Element {
    return (
      this.cachedData["RadialHuePicker"] ?? this.updateCache("RadialHuePicker")
    );
  }
  ...
  public get BoundIntInputField(): (props: BoundIntInputField) => JSX.Element {
    return (
      this.cachedData["BoundIntInputField"] ??
      this.updateCache("BoundIntInputField")
    );
  }
  public get EllipsisTextInput(): (props: EllipsisTextInput) => JSX.Element {
    return (
      this.cachedData["EllipsisTextInput"] ??
      this.updateCache("EllipsisTextInput")
    );
  }
  ...
  public get checkboxTheme(): Theme | any {
    return (
      this.cachedData["checkboxTheme"] ?? this.updateCache("checkboxTheme")
    );
  }
  ...
  public get textInputTheme(): TextInputTheme | Theme | any {
    return (
      this.cachedData["textInputTheme"] ?? this.updateCache("textInputTheme")
    );
  }
  public get ellipsesTextInputTheme(): EllipsesTextInputTheme | Theme | any {
    return (
      this.cachedData["ellipsesTextInputTheme"] ??
      this.updateCache("ellipsesTextInputTheme")
    );
  }
  public get assetGridTheme(): Theme | any {
    return (
      this.cachedData["assetGridTheme"] ?? this.updateCache("assetGridTheme")
    );
  }

  public get FOCUS_DISABLED(): UniqueFocusKey {
    return (
      this.cachedData["FOCUS_DISABLED"] ?? this.updateCache("FOCUS_DISABLED")
    );
  }
  ...
  public get useScrollController(): () => ScrollController {
    return (
      this.cachedData["useScrollController"] ??
      this.updateCache("useScrollController")
    );
  }
}
